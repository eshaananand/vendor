      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("Enter the verification Code , We've sent on the given number",style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.all(20.0),
              child: Text("Resend",style: TextStyle(color: Colors.red,fontSize: 15,fontWeight: FontWeight.bold),),
            ),
            Padding(
